...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print LeopardCoin address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "leopardcoin",               "masternode",             &masternode,             true,  {} },
    { "leopardcoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "leopardcoin",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "leopardcoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "leopardcoin",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "leopardcoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
