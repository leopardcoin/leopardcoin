...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in leopardcoin.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("leopardcoin.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    ...
    { "leopardcoin",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "leopardcoin",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "leopardcoin",               "gobject",                &gobject,                true,  {} },
    { "leopardcoin",               "voteraw",                &voteraw,                true,  {} },
