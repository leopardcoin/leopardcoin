...
2. run leopardcoind with -printalert or -sendalert like this:
   /path/to/leopardcoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.leopardcoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/LeopardCoin Core:0.12.0.58/"));
