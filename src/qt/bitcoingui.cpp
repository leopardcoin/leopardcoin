...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LeopardCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and leopardcoin: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about LeopardCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LeopardCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LeopardCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a leopardcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible LeopardCoin command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LeopardCoin network", "", count));
    } else {
...
{
    QString strTitle = tr("LeopardCoin Core"); // default title
    ...
    // Append title to "LeopardCoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
