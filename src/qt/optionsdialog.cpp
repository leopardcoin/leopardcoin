    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("LEO-light"), QVariant("light"));
    ui->theme->addItem(QString("LEO-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("LEO-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("LEO-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("LEO-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("LEO-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("LEO-traditional"), QVariant("trad"));
