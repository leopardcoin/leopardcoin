    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  leopardcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the LeopardCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 LEO, 0.1 LEO, 1 LEO and 10 LEO -- sort of like the paper money you use every day.</li> \
