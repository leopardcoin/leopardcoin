...
This mechanism has been integrated into Bitcore-Node-LeopardCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/leopardcoinpay/insight-api-leopardcoin#web-socket-api](https://github.com/leopardcoinpay/insight-api-leopardcoin#web-socket-api)
* API: [https://github.com/leopardcoinpay/insight-api-leopardcoin#instantsend-transactions](https://github.com/leopardcoinpay/insight-api-leopardcoin#instantsend-transactions)
...
By default, the LeopardCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the LeopardCoin Core daemon:
