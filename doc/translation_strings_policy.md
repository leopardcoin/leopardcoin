...
This document provides guidelines for internationalization of the LeopardCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `leopardcoin_en.ts` remains unchanged.
