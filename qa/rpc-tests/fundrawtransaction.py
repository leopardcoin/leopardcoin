...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid leopardcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid leopardcoin address" in e.error['message'])
